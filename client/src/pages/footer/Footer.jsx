    ...
    <div className="footerWraper">
      <div className="footerLeft">
        ...
        <p>
          ...
          organization has been successfully doing business honestly for a long
          time and has been able to gain the trust of the users.
        </p>
      </div>
      <div className="footerCenter">
        <h2 className="footerLabel">Terms and Conditions</h2>
